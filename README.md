...
böler, biri yoğunsa beklemeden ötekine geçer ve yoğun olanı bir dakika sıranın sonuna koyar. Şu an iki çözücü
var: Vercel ve Netlify. Sibnet'in engeli geçici ve IP'ye özel (Cloudflare'deki gibi kalıcı değil); denemelerde
biri engelliyken öteki çalışıyordu.
...
Vercel kopyası `main`'e her push'ta kendiliğinden yayınlanır; Netlify kopyası GitHub'a bağlı değil,
`api/sibnet.js` değişince elle yayınlanmalı (bkz. `cozucu-netlify/README.md`).
