...
function renderLegal() {
  ...
  const en = `
      ...
      <p>Anime cover images are loaded from <a href="https://anilist.co" target="_blank" rel="noopener noreferrer">AniList</a>, and episode players are embedded from their respective video-hosting sites; these third-party services are subject to their own privacy policies and cookies, which are outside this site's control. When an episode plays in the ad-free player, the anime's MyAnimeList ID, the episode number and the video length are sent to <a href="https://aniskip.com" target="_blank" rel="noopener noreferrer">AniSkip</a> to find when the opening and ending play; character, voice actor and theme song information (from AniList and <a href="https://animethemes.moe" target="_blank" rel="noopener noreferrer">AnimeThemes</a>) is collected ahead of time and served from this site. The page's typeface (Inter, <a href="https://scripts.sil.org/OFL" target="_blank" rel="noopener noreferrer">SIL Open Font License</a>) is served from this site itself, so no request is made to Google Fonts.</p>
      <p>For the "Watch ad-free" option on Sibnet and Uqload episodes, the site calls a small helper function hosted on <a href="https://vercel.com" target="_blank" rel="noopener noreferrer">Vercel</a> or <a href="https://www.netlify.com" target="_blank" rel="noopener noreferrer">Netlify</a> (for Sibnet, <code>tka-sibnet.vercel.app</code> or <code>tka-sibnet.netlify.app</code>) or <a href="https://www.cloudflare.com" target="_blank" rel="noopener noreferrer">Cloudflare</a> Workers (for Uqload, <code>tka-uqload.turkanime-arsiv.workers.dev</code>). This function receives only the provider's video ID, resolves the direct video address and returns it; it keeps no database, sets no cookies, and does not store the request. As with any web request, your IP address is technically visible to that provider's infrastructure for the duration of the request and may appear in its short-lived operational logs, subject to <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">Vercel's</a>, <a href="https://www.netlify.com/privacy/" target="_blank" rel="noopener noreferrer">Netlify's</a> or <a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener noreferrer">Cloudflare's</a> privacy policy. The video itself is then streamed directly from that provider's own servers to your browser, exactly as with the classic embedded player. For Uqload, which delivers video as HLS (a segmented streaming format), the browser also loads a small open-source player library (hls.js) from a public CDN (jsDelivr) to play it.</p>
  ...
  const tr = `
      ...
      <p>Anime kapak görselleri <a href="https://anilist.co" target="_blank" rel="noopener noreferrer">AniList</a>'ten, bölüm oynatıcıları ise ilgili video barındırma sitelerinden (embed) yüklenir; bu üçüncü taraf servisler kendi gizlilik politikalarına ve çerezlerine tabidir, bu sitenin sorumluluğunda değildir. Bir bölüm reklamsız oynatıcıda açıldığında, opening ve ending'in ne zaman çaldığını bulmak için animenin MyAnimeList kimliği, bölüm numarası ve video süresi <a href="https://aniskip.com" target="_blank" rel="noopener noreferrer">AniSkip</a>'e gönderilir; karakter, seslendirmen ve şarkı bilgileri (AniList ve <a href="https://animethemes.moe" target="_blank" rel="noopener noreferrer">AnimeThemes</a>) önceden toplanıp sitenin kendisinden sunulur. Sayfanın yazı tipi (Inter, <a href="https://scripts.sil.org/OFL" target="_blank" rel="noopener noreferrer">SIL Open Font License</a>) üçüncü taraftan değil sitenin kendi sunucusundan yüklenir; yani Google Fonts'a hiçbir istek gitmez.</p>
      <p>Sibnet ve Uqload bölümlerindeki "Reklamsız izle" seçeneği için site, <a href="https://vercel.com" target="_blank" rel="noopener noreferrer">Vercel</a> ya da <a href="https://www.netlify.com" target="_blank" rel="noopener noreferrer">Netlify</a> üzerinde (Sibnet için, <code>tka-sibnet.vercel.app</code> ya da <code>tka-sibnet.netlify.app</code>) ya da <a href="https://www.cloudflare.com" target="_blank" rel="noopener noreferrer">Cloudflare</a> Workers üzerinde (Uqload için, <code>tka-uqload.turkanime-arsiv.workers.dev</code>) barındırılan küçük bir yardımcı fonksiyona istek atar. Bu fonksiyon yalnızca ilgili sağlayıcının video numarasını alır, videonun doğrudan adresini çözüp geri döndürür; veritabanı tutmaz, çerez kullanmaz, isteği kaydetmez. Her web isteğinde olduğu gibi IP adresin istek süresince ilgili altyapı tarafından teknik olarak görülür ve <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">Vercel'in</a>, <a href="https://www.netlify.com/privacy/" target="_blank" rel="noopener noreferrer">Netlify'ın</a> ya da <a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener noreferrer">Cloudflare'in</a> gizlilik politikası kapsamında kısa süreli işletim kayıtlarında yer alabilir. Videonun kendisi ise klasik gömülü oynatıcıda olduğu gibi doğrudan ilgili sağlayıcının sunucularından tarayıcına akar. HLS formatıyla video veren Uqload için tarayıcı ayrıca halka açık bir CDN'den (jsDelivr) küçük bir açık kaynak oynatıcı kütüphanesi (hls.js) yükler.</p>
