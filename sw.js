...
const SHELL_CACHE = 'tka-shell-v24';
...
const SHELL = ['./', 'index.html', 'style.css', 'kaynak/data.js', 'meta.js',
  ...
  'js/main.js', 'js/cards.js', 'js/cozum.js', 'js/data.js', 'js/dom.js', 'js/eslesme.js', 'js/links.js',
...
const isData = url => /\/kaynak\/b\/[^/]+\.js$/.test(url.pathname) || /\/kaynak\/(x|sv)\/[^/]+\.json$/.test(url.pathname) || /\/kaynak\/animeler\/[^/]+\/info\.json$/.test(url.pathname);
